...
void            sched1(void) __attribute__((noreturn));
void            sched2(void) __attribute__((noreturn));
void            sched(void);
...
void            procdump(void);
void            set_sched_sjf(int, int, int);
...
int             is_time_to_yield(struct proc*);
void            print_proc_state(char*, struct proc*);
